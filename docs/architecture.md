...
WAL segment recycling, transaction-aware dirty pages, and platform-specific
I/O optimization remain follow-up work; their absence does not weaken the
current write-ahead and atomic-batch recovery invariants.
